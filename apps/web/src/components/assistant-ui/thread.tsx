...
export type ThreadProps = {
	 ...
	 * keeps pinned to it while the reader is at the bottom. "top" anchors each
	 * new user message at the top of the viewport and disables auto-scroll.
	 */
	turnAnchor?: "top" | "bottom" | undefined;
	/**
	 * Whether a starting run scrolls to the newest message. Queues a scroll that
	 * the viewport re-applies on every content resize until it is cleared, which
